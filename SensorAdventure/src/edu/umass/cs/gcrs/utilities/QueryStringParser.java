...
public class QueryStringParser {
	 ...
	 * 
	 * @param queryString
	 *            the query string, i.e. the part of the URL starting after the
	 *            '?' character
	 */
	...
	/**
	 * Get the name of the current parameter. Calling this method is only
	 * allowed if {@link #next()} has been called previously and the result of
	 * this call was <code>true</code>. Otherwise the result of this method is
	 * undefined.
	 * 
	...
	/**
	 * Get the value of the current parameter. Calling this method is only
	 * allowed if {@link #next()} has been called previously and the result of
	 * this call was <code>true</code>. Otherwise the result of this method is
	 * undefined.
	 * 
