...
public class Gyroscope extends Service implements SensorEventListener {
	...
	public void onCreate() {
		Toast.makeText(this, "Start taking gyroscope data", Toast.LENGTH_LONG)
				.show();
		...
		if (mSensorManager.getDefaultSensor(Sensor.TYPE_GYROSCOPE) != null) {
			...
			try {
				...
				Toast.makeText(this,
						...
						Toast.LENGTH_LONG).show();
				Toast.makeText(this,
						"Sorry! The gyroscope is not found in the device.",
						Toast.LENGTH_LONG).show();
				FileWriter output = new FileWriter(file);
				telephonyManager = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
				output.write("Phone ID: " + telephonyManager.getDeviceId());
	...
	public void onDestroy() {
		Toast.makeText(this, "Stop taking gyroscope data", Toast.LENGTH_LONG)
				.show();
		Toast.makeText(this,
