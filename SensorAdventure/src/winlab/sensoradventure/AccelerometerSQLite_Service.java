...
SensorEventListener {
    ...
    private Accelerometer_SQLite data; 
	@Override
	...
	public void onCreate() {
		Toast.makeText(this, "Start taking accelerometer readings", Toast.LENGTH_LONG).show();
		...
		if (mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER) != null) {
			mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
				...
				data = new Accelerometer_SQLite(this);
			 ...
			 data = new Accelerometer_SQLite(this);
				...
				data.deleteTable();
				for (int i=0; i<7; i++)
				data.insertTitle("10", " w", "wq ", "r ");
				Toast.makeText(this,"Sorry! The accelerometer is not found in the device.", Toast.LENGTH_LONG).show();
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
				...
				if (Rate==10)
				{
					data.insertTitle(timestamp, str1, str2, str3);
					Rate=0;
				}
	...
	public void onDestroy() {
		...
		Toast.makeText(this, "Stop taking accelerometer readings", Toast.LENGTH_LONG).show();
	    ...
	    if (c.moveToFirst())
	    {
	        do {          
	        	count++;
	            result=result+c.getString(1)+"    "+c.getString(2)+"    "+c.getString(3)+"      "+c.getString(4)+"\n";
