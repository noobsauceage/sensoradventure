...
SensorEventListener{
	...
	public void onCreate() {
		Toast.makeText(this, "Start taking linear acceleration data", Toast.LENGTH_LONG).show();
		...
		public void onDestroy() {
			Toast.makeText(this, "Stop taking linear acceleration data", Toast.LENGTH_LONG).show();
