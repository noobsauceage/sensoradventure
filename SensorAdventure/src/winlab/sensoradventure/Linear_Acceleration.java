...
public class Linear_Acceleration extends Service implements SensorEventListener {
	...
	public void onCreate() {
		Toast.makeText(this, "Start taking linear acceleration data",
		...
		if (mSensorManager.getDefaultSensor(Sensor.TYPE_LINEAR_ACCELERATION) != null) {
			...
			try {
				...
				Toast.makeText(this,
						...
						Toast.LENGTH_LONG).show();
				Toast.makeText(this,
						"Sorry! The sensor is not found in the device.",
						Toast.LENGTH_LONG).show();
				FileWriter output = new FileWriter(file);
				telephonyManager = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
				output.write("Phone ID: " + telephonyManager.getDeviceId());
	...
	public void onDestroy() {
		Toast.makeText(this, "Stop taking linear acceleration data",
				Toast.LENGTH_LONG).show();
		Toast.makeText(this,
