...
/**
 * This is the MainActivity Class, the activity currently has two buttons
 * Start_Log and Logging Interval, the Default Logging Interval is set to 1
 * minute
 */
public class MainActivity extends Activity {
	...
	private void addButtonListeners() {
		...
		((Button) findViewById(R.id.start_logging))
				.setOnClickListener(btnClick);
		((Button) findViewById(R.id.logging_interval))
				.setOnClickListener(btnClick);
	}
	...
	private void changeLoggingIntercal() {
		...
		final String loggingIntervals[] = { "1 minutes", "5 minutes",
				"10 minutes", "1 hour" };

		builder.setTitle("Logging Interval");
		builder.setSingleChoiceItems(loggingIntervals, currentIntervalChoice,
